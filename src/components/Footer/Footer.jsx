...
const Footer = () => {
  ...
  useEffect(() => {
    const updateSeoulTime = () => {
      ...
      const seoulTimeString = formatter.format(new Date());
      setSeoulTime(seoulTimeString);
    };

    updateSeoulTime();
    const timeInterval = setInterval(updateSeoulTime, 1000);
      ...
      <div className="container">
        <div className="footer-header-content">
          <div className="footer-header">
            <Copy animateOnScroll={true} delay={0.2}>
              <h1>Let's build a polished web experience together</h1>
            </Copy>
          </div>
        ...
        <div className="footer-byline">
          <div className="footer-time">
            <p>
              Seoul, KR <span>{seoulTime}</span>
            </p>
          </div>

          <div className="footer-author">
            <p>Published by Web Publisher</p>
          </div>
